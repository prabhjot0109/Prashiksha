...
import com.example.prashiksha.databinding.ActivityInterface1Binding;  // Ensure this matches your layout file name

public class Interface1Activity extends AppCompatActivity {

    private ActivityInterface1Binding binding;  // Correct the binding class name

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityInterface1Binding.inflate(getLayoutInflater());  // Ensure this matches your layout file name
